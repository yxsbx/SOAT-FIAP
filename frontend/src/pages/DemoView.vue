...
const demoContext = computed(() => {
  if (leadForm.demoProfile === 'partsStore') {
    return {
      ...
      heroText:
        'Fluxo reduzido para experimentar pedidos, estoque e atendimento a oficinas sem expor todos os recursos internos.',
  ...
  <main class="demo-shell">
    ...
    <section v-if="!leadRegistered" class="demo-gate">
      <div>
        ...
        <p>
          A AutoCare Hub conecta oficinas e lojas de peças a clientes, com ferramentas para receber contatos, montar
          orçamentos, controlar estoque, acompanhar vendas e organizar a operação.
        </p>
      ...
      <form class="demo-form" @submit.prevent="submitLead">
        ...
        <label>
          Nome da empresa
          <input
            v-model.trim="leadForm.companyName"
            :placeholder="demoContext.companyPlaceholder"
            maxlength="120"
            required
          />
        </label>
        ...
        <button :disabled="saving" class="secondary-button" type="submit">Solicitar demonstração</button>
      </form>
    </section>
    ...
    <section v-else class="demo-workspace">
      <div class="demo-alert">
        ...
        <div>
          ...
          <span>
            As alterações abaixo ficam somente na memória desta tela. Ao atualizar com F5, os dados temporários somem.
          </span>
        </div>
      </div>
