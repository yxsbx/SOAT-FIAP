...
public class ListUsersUseCase {
    ...
    public List<User> execute(Query query) {
        return userRepository.findAll().stream()
                ...
                .filter(user -> query == null || query.role() == null || user.role().name().equals(query.role()))
                .filter(user -> query == null || query.profileType() == null || user.profileType().equals(query.profileType()))
