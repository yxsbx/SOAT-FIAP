...
public class CreateServiceOrderUseCase {
    ...
    public CreateServiceOrderUseCase(ServiceOrderRepository serviceOrderRepository, CustomerRepository customerRepository, VehicleRepository vehicleRepository) {
    ...
    public ServiceOrder execute(Command command) {
        ...
        ServiceOrder serviceOrder = new ServiceOrder(command.customerId(), command.vehicleId(), command.diagnosticNotes());
