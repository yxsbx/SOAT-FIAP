...
public class Part {
    ...
    public Part(String name, String sku, String category, String subcategory, String brand, Money unitPrice, int stockQuantity, int minimumStock) {
        this(UUID.randomUUID(), name, sku, category, subcategory, brand, unitPrice, stockQuantity, minimumStock, true);
    }

    public Part(UUID id, String name, String sku, String category, String subcategory, String brand, Money unitPrice, int stockQuantity, int minimumStock, boolean active) {
    ...
    public void update(String name, String sku, String category, String subcategory, String brand, Money unitPrice, int minimumStock) {
        this.name = requireText(name, "Name is required");
        this.sku = requireText(sku, "SKU is required");
        this.category = requireText(category, "Category is required");
        this.subcategory = subcategory == null ? null : subcategory.trim();
