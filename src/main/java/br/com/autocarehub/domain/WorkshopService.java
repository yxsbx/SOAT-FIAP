...
public class WorkshopService {
    ...
    public WorkshopService(UUID id, String name, String description, Money basePrice, int estimatedTimeInMinutes, boolean active) {
        ...
        this.estimatedTimeInMinutes = requirePositive(estimatedTimeInMinutes, "Estimated time must be greater than zero");
        this.active = active;
    }
