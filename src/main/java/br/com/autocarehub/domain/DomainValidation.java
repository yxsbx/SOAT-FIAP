...
final class DomainValidation {
  ...
  static String requireText(String value, String message, int maxLength) {
    if (value.isBlank()) {
  ...
  static @Nullable String optionalText(@Nullable String value) {
  ...
  static String requireState(String value) {
  ...
  static int requireVehicleYear(int value) {
