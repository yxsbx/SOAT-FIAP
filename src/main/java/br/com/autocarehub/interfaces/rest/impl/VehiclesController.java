...
public class VehiclesController implements VehiclesApi {
    ...
    public VehiclesController(CreateVehicleUseCase createVehicleUseCase, UpdateVehicleUseCase updateVehicleUseCase, FindVehicleUseCase findVehicleUseCase, ListVehiclesUseCase listVehiclesUseCase, DeleteVehicleUseCase deleteVehicleUseCase, ListVehiclesByCustomerUseCase listVehiclesByCustomerUseCase) {
    ...
    public ResponseEntity<VehicleListResponse> listVehiclesByCustomer(UUID customerId) {
        return ResponseEntity.ok(VehicleRestMapper.toListResponse(listVehiclesByCustomerUseCase.execute(customerId), null, null));
    }
