...
public final class CustomerRestMapper {
    ...
    public static CustomerListResponse toListResponse(List<Customer> customers, Integer page, Integer size) {
        List<CustomerResponse> items = RestMapperSupport.page(customers, page, size).stream()
                ...
                .toList();
        CustomerListResponse response = new CustomerListResponse(items, page == null ? 0 : page, size == null ? customers.size() : size, (long) customers.size(), RestMapperSupport.totalPages(customers.size(), size));
        return response;
    }

    public static br.com.autocarehub.domain.Address toDomainAddress(br.com.autocarehub.interfaces.rest.generated.model.Address address) {
        if (address == null) {
            return null;
        }
    ...
    public static br.com.autocarehub.interfaces.rest.generated.model.Address toApiAddress(br.com.autocarehub.domain.Address address) {
        if (address == null) {
            return null;
        }
