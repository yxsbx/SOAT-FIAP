...
public final class ServiceOrderJpaMapper {
    ...
    public static ServiceOrderJpaEntity toEntity(ServiceOrder serviceOrder) {
        ...
        entity.replaceServices(serviceOrder.services().stream().map(ServiceOrderJpaMapper::toServiceEntity).toList());
        entity.replaceParts(serviceOrder.parts().stream().map(ServiceOrderJpaMapper::toPartEntity).toList());
        return entity;
    }
