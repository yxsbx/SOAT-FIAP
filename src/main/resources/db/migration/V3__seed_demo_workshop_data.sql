...
VALUES ('10000000-0000-0000-0000-000000000001', 'Mariana Costa', 'CPF', '12345678909', '11988887777',
       ...
       ('10000000-0000-0000-0000-000000000005', 'Joao Pereira', 'CPF', '32165498701', '11955554444',
        'joao.pereira@email.com', 'Rua Augusta', '1001', NULL, 'Consolacao', 'Sao Paulo', 'SP', '01305000', TRUE,
...
VALUES ('30000000-0000-0000-0000-000000000001', 'Diagnostico eletronico',
        'Leitura de scanner, inspecao de falhas e relatorio tecnico para o cliente.', 180.00, 60, TRUE),
       ('30000000-0000-0000-0000-000000000002', 'Troca de oleo e filtros',
        'Substituicao de oleo do motor, filtro de oleo, filtro de ar e checklist visual.', 220.00, 75, TRUE),
       ...
       ('30000000-0000-0000-0000-000000000004', 'Servico de freios',
        'Inspecao e substituicao de pastilhas, discos e sangria quando necessario.', 360.00, 150, TRUE),
       ...
       ('30000000-0000-0000-0000-000000000006', 'Higienizacao do ar-condicionado',
        'Limpeza do sistema, troca de filtro de cabine e eliminacao de odores.', 160.00, 60, TRUE),
       ('30000000-0000-0000-0000-000000000007', 'Troca de correia dentada',
        'Substituicao do kit de correia dentada e verificacao do sincronismo do motor.', 680.00, 300, TRUE),
       ('30000000-0000-0000-0000-000000000008', 'Diagnostico de suspensao',
        'Avaliacao de buchas, amortecedores, bandejas, pivots e terminais.', 140.00, 60,
...
VALUES ('40000000-0000-0000-0000-000000000001', 'Oleo sintetico 5W30 1L', 'OLE-5W30-001', 'Lubrificantes', 'Motor',
       ...
       ('40000000-0000-0000-0000-000000000010', 'Bateria 60Ah', 'ELE-BAT-60AH', 'Eletrica', 'Bateria', 'Moura', 520.00,
        2, 3, TRUE),
       ('40000000-0000-0000-0000-000000000011', 'Lampada H7', 'ELE-LMP-H7', 'Eletrica', 'Iluminacao', 'Osram', 49.00,
        20, 8, TRUE),
       ('40000000-0000-0000-0000-000000000012', 'Vela de ignicao iridium', 'MOT-VEL-IRI01', 'Motor', 'Ignicao', 'NGK',
        68.00, 22, 12, TRUE),
...
VALUES ('50000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001',
        ...
        'Cliente relata vibracao ao frear acima de 80 km/h. Nota: revisar discos dianteiros, pastilhas e fluido.',
       ...
       ('50000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001',
        ...
        'Revisao de 30 mil km. Nota: cliente pediu priorizar troca de oleo, filtros e higienizacao do ar.', 656.50,
       ...
       ('50000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000002',
        ...
        'Luz de injecao acesa e consumo elevado. Nota: scanner apontou falha intermitente em vela de ignicao.', 632.00,
       ...
       ('50000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000004',
        ...
        'Veiculo de frota chegou para revisao preventiva. Nota: motorista reportou dificuldade de partida pela manha.',
       ...
       ('50000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000004',
        ...
        'Utilitario com ruido ao acionar embreagem. Nota: avaliar kit de embreagem antes de liberar orcamento.', 180.00,
...
VALUES ('60000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000001',
       ...
       ('60000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000002',
        '30000000-0000-0000-0000-000000000006', 'Higienizacao do ar-condicionado', 1, 160.00, 160.00),
...
VALUES ('70000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000001',
       ...
       ('70000000-0000-0000-0000-000000000007', '50000000-0000-0000-0000-000000000003',
        '40000000-0000-0000-0000-000000000012', 'Vela de ignicao iridium', 'MOT-VEL-IRI01', 4, 68.00, 272.00),
