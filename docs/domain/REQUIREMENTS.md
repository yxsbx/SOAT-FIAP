...
|---------|----------------------------------|----------------|---------------------------------------------------------------|-----------------------------------------------------------------------------|----------------------------------------------------------------|----------|
| RNF-001 | Backend monolítico               | Arquitetura    | Backend entregue como uma única aplicação Spring Boot.        | Existe uma aplicação principal `AutoCareHubApiApplication`.                 | `backend/pom.xml`, `Dockerfile`, `backend/src/main/java`.                      | Atendido |
...
| RNF-008 | Docker Compose completo          | Execução local | Subir banco, backend e frontend demonstrativo.                | `.\scripts\start-local.ps1 -Rebuild -Reset` sobe os serviços definidos.                  | `docker-compose.yml`.                                          | Atendido |
