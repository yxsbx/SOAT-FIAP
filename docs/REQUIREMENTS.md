...
| RF-011 | Incluir serviços solicitados na OS           | Adicionar serviços na criação ou depois da OS.                                      | `POST /api/v1/service-orders/{id}/services` inclui item válido.                | `AddServiceToServiceOrderUseCase`, `ServiceOrder`.                                         | Atendido |
| RF-012 | Incluir peças/insumos na OS                  | Adicionar peças na criação ou depois da OS.                                         | `POST /api/v1/service-orders/{id}/parts` respeita o estoque disponível.        | `AddPartToServiceOrderUseCase`, `Part`, `ServiceOrderFlowIntegrationTest`.                 | Atendido |
...
| RF-019 | Detalhar Ordem de Serviço                    | Permitir consulta de uma OS específica.                                             | `GET /api/v1/service-orders/{id}` retorna detalhe da OS.                       | `FindServiceOrderUseCase`, `ServiceOrdersController`.                                      | Atendido |
