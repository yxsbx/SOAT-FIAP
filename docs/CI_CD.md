...
2. Selecionar o workflow `Deploy`.
3. Clicar em `Run workflow`.
4. Acompanhar os jobs `build-test-and-image` e `deploy-kubernetes`.
...
Nao afirme que houve deploy real se o job apenas executou as etapas de build/validacao ou pulou o Kubernetes por falta de secrets.
