...
O backend está em `backend/src/main/java/br/com/autocarehub` e segue uma separação em camadas:
...
O contrato principal está em `docs/api/openapi/openapi.yaml`. Ele documenta:
