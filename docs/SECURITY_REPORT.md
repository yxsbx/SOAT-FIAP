...
|--------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|
| Broken Access Control                      | Cliente acessar dados de outro cliente, admin de empresa gerenciar usuários fora do escopo ou executar ação administrativa | JWT, papéis, autorização por `customerId` nos fluxos de OS/cliente e escopo de empresa na gestão de usuários | `SecurityConfig`, `AuthorizationService`, `UsersController`, `SecurityAuthorizationIntegrationTest` |
